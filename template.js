...
<body
  ...
  <span class="preheader"
    style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">${title}</span>
              ...
              <td class="wrapper"
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                  ...
                  <tr><td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom:
                        15px;color:#36454F">
                        Dear ${name},</p>
                      <p style="color:#36454F ;font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0;
                        margin-bottom: 15px">
